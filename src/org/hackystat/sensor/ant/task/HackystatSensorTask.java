...
public abstract class HackystatSensorTask extends Task {
   ...
   * execute() method. The reason is that the toolAccount property which controls where
   * the SensorShell data is obtained is not set until Ant finishes constructor setup. 
   */
   ...
   * sensor is running. Default is false. 
   * 
